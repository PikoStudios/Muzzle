...
ifeq ($(PLATFORM),PLATFORM_DESKTOP)
    ...
    ifeq ($(PLATFORM_OS),LINUX)
        ...
        INCLUDE_PATHS = -I$(MUZZLE_PATH)/include -I$(RAYLIB_H_INSTALL_PATH) -isystem. -isystem$(RAYLIB_PATH)/src -isystem$(RAYLIB_PATH)/release/include -isystem$(RAYLIB_PATH)/src/external
    endif
endif
...
MUZZLE_SRC_PATHS = $(MUZZLE_PATH)/Muzzle/core/*.c $(MUZZLE_PATH)/Muzzle/textures/*.c
