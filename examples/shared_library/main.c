...
int main(void)
{
	mz_applet applet = mz_initialize_applet("Muzzle [EXAMPLES] - Muzzle from a shared library!", SCREEN_WIDTH, SCREEN_HEIGHT, APPLET_FLAG_RESIZBALE | APPLET_FLAG_TRACK_DELTA_TIME);
