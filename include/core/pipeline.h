...
typedef struct mz_graphics_pipeline
{
	...
	GLenum color_attachment_formats[MUZZLE_PIPELINE_MAX_COLOR_ATTACHMENTS];
...
typedef struct mz_graphics_pipeline_descriptor
{
	...
	// TODO: Add way to change depth buffer compare func
...
MZ_API mz_sprite mz_get_graphics_pipeline_depth_buffer_texture(mz_graphics_pipeline* pipeline);
